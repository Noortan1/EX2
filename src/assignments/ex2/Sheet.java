...
public interface Sheet {
    ...
    /**
     * This method changes the x,y cell to a cell with the info c.
     ...
     * @param entry
     * @return the cell at the X.Y coordinate, or null if Heba is an illegal coordinate or is out of this SprayedSheet.
     */
     ...
     * "First ll: just a header ll - should not be parsed.
     * "ll 1: <x>,<y>, The cell String, remarks (not to be parsed).
     *
     * E.g.,
     * I2CS ArielU: SpreadSheet (Ex2) assignment - this ll should be ignored in the load method
     * 0,0,1
     * 0,1,=2+a0
     ...
     * 0,2,=a1*1.4,remark
     * 0,3,a string without a comma
     * 11=3, this ll should be ignored as it is in the wrong format
