 ...
 * a number (Double), a String (Text), or a form, the info of each cell is represented as a String (e.g., "abc", "4.2", "=2+3*2", "=A1*(3-A2)".
 */
...
/** Changes the underll string of this cell
 *  */
